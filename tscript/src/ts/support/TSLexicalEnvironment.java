...
public final class TSLexicalEnvironment
{
	...
	/**delete varbinding**/
	public void delVarBinding(final TSString name)
	{
		environmentRecord.deleteBinding(name);
	}
	...
	public void declareParameter(final String rawName, TSValue value)
	{
		...
		{
			System.err.println("binding already exists for parameter");
	...
	/** Create a new obj environment, which must be placed inside
	 *  a new lexical environment.
	 *
	 *  @param obj object
	 *  @param outer the enclosing lexical environment
	 */
	public static TSLexicalEnvironment newObjectEnvironment(final TSObject obj,
			final TSLexicalEnvironment outer)
	{
		return new TSLexicalEnvironment(new TSObjectEnvironmentRecord(obj,true),
				outer);
	}
